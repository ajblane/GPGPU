...
# Sat Sep 06 07:03:56 CST 2014
# DO NOT MODIFY


# 
# GPGPU "GPGPU" v1.0
# ajblane 2014.09.06.07:03:56
# 
# 
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL gpgpu
...
add_fileset_file gpgpu.sv SYSTEM_VERILOG PATH ../core/gpgpu.sv TOP_LEVEL_FILE
...
add_interface_port avalon_slave_0 io_write_en writeresponsevalid_n Output 1
add_interface_port avalon_slave_0 io_read_en writeresponsevalid_n Output 1
add_interface_port avalon_slave_0 io_address readdata Output 32
add_interface_port avalon_slave_0 io_write_data readdata Output 32
add_interface_port avalon_slave_0 io_read_data writebyteenable_n Input 32
